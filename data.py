...
projects = [
    {
        ...
        "description": (
            "<p><em>GCN-based Scheduler for Distributing Computation in the Internet of Robotic Things</em></p><p>This project explores how graph convolutional neural networks can be trained to immitate well-known task-graph scheduling algorithms for fast re-scheduling over networks with highly dynamic communication links. First-place winner of <a href='https://smile-sdsu.github.io/cps_iot22/'>The 2nd Student Design Competition on Networked Computing on the Edge</a> at <a href='https://cpsiotweek.neslab.it/'>CPS IoT Week 2022</a>.</p>"
